        ...
        >
          ...
          <template #actions>
            <Button
              ...
              "
            >
              {{ projectMoveDialog.team ? `${__("Move to")} ${projectMoveDialog.team.label}` : __('Move') }}
            </Button>
          </template>
        </Dialog>
        <Dialog
        ...
        >
          <template #body-content>
            <p class="text-p-base text-ink-gray-8 mb-4">
              {{__('This will move all discussions, tasks, and pages from the')}}
              <span class="whitespace-nowrap font-semibold">{{ project.doc.title }}</span> {{__('project')}}
              {{__('to the selected project. This change is irreversible!')}}
            </p>
          ...
          <template #actions>
            ...
            >
              {{
                projectMergeDialog.project
                  ? `${__("Merge with")} ${projectMergeDialog.project.label}`
                  : __('Merge')
              }}
            </Button>
          </template>
